...
var Registry = Response{Modules: []Module{
	{
		...
		Routes: []Route{
			...
			{Method: "GET", Path: "/auth/oidc", Summary: "Begin the OIDC handshake", Description: "Redirects to Porte.", Errors: []Error{internalError}},
			{Method: "GET", Path: "/auth/oidc/callback", Summary: "Complete the OIDC handshake", Description: "Redirects back with the session token in the URL fragment, never the query string.", Errors: []Error{badRequest, unauthenticated, internalError}},
	...
	{
		Name:        "status",
		Description: "What this Jardin instance holds.",
		Routes: []Route{
	...
	{
		Name:        "rules",
		Description: "The agent rules Jardin renders into each tool's native config.",
		Routes: []Route{
	...
	{
		Name:        "skills",
		Description: "The skills Jardin installs into each agent.",
		Routes: []Route{
