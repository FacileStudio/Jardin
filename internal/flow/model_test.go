...
// trustModel pins through InspectModel rather than hashing the entry file, so
// the tests approve what production approves: the whole import closure.
