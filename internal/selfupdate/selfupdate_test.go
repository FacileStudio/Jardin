...
func TestAssetName(t *testing.T) {
	cases := []struct {
		...
		{"0.2.0", "darwin", "arm64", "Jardin_0.2.0_darwin_arm64.tar.gz"},
		{"v0.2.0", "linux", "amd64", "Jardin_0.2.0_linux_amd64.tar.gz"},
		{"1.0.0", "darwin", "amd64", "Jardin_1.0.0_darwin_amd64.tar.gz"},
	}
	for _, c := range cases {
