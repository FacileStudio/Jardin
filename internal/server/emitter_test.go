...
func mkBlock(id, machine string, end time.Time) sessions.Block {
	return sessions.Block{ID: id, Project: "Jardin", Machine: machine, Agent: "claude",
...
func TestEnvelopeShape(t *testing.T) {
	...
	if evt.IdempotencyKey != "jardin_agent_session_created_abc123" {
	...
	for _, want := range []string{`"object":"agent_session"`, `"app":"Jardin"`, `"user_email":"sara@example.com"`} {
