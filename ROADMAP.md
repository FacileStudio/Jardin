...
index doesn't resolve a semantic conflict". Mycelium's `[SUPERSEDED by: ...]` is inline, so nothing
...
contextual BM25 joins it. **Mycelium already banks part of this through the page** — `hybrid.go`
...
mycelium is weak, on "when was this true and is it still". That is measured upside for B1 and B2,
